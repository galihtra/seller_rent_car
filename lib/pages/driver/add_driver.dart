...
class _AddDriverState extends State<AddDriver> {
  ...
  Future<void> _addDriver() async {
    ...
    final noSim = noSimController.text;
    ...
    if (imageUrl != null && name.isNotEmpty) {
      ...
      if (taskSnapshot.state == TaskState.success) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Pengemudi telah ditambahkan!'),
          ),
        );
      } else {
        ScaffoldMessenger.of(context).showSnackBar(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Tambah pengemudi"),
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 10.0),
              TextField(
                controller: noSimController,
                decoration: const InputDecoration(labelText: 'No Sim '),
              ),
              const SizedBox(height: 10.0),
              TextField(
