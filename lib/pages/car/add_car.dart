  ...
  Future<void> _addCar() async {
    ...
    if (imageUrl != null && name.isNotEmpty && type.isNotEmpty) {
      ...
      if (taskSnapshot.state == TaskState.success) {
        ...
        final DocumentReference docRef = await carRef.add(car.toJson());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Tambah Mobil Rental"),
          ...
          child: Column(
            children: [
              ...
              ToggleSwitch(
                ...
                inactiveBgColor: const Color.fromARGB(255, 105, 104, 104),
                inactiveFgColor: Colors.white,
                totalSwitches: 2,
                labels: const ['2-5', '6-9'],
                icons: const [Icons.people, Icons.people],
                onToggle: (index) {
                  passengerCategory = index == 0 ? '2-5' : '6-9';
                },
              ),
              TextField(
